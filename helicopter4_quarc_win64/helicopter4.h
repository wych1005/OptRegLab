...
#ifndef RTW_HEADER_helicopter4_h_
#define RTW_HEADER_helicopter4_h_
#include <math.h>
#include <string.h>
#ifndef helicopter4_COMMON_INCLUDES_
# define helicopter4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter4_COMMON_INCLUDES_ */

#include "helicopter4_types.h"
...
#define helicopter4_rtModel            RT_MODEL_helicopter4_T
...
typedef struct {
  ...
  real_T FromWorkspace1[6];            /* '<S6>/From Workspace1' */
  ...
  real_T TmpSignalConversionAtToWorksp_o[12];
} B_helicopter4_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_b;               /* '<S6>/To Workspace' */
...
#define rtB                            helicopter4_B
#define BlockIO                        B_helicopter4_T
#define rtX                            helicopter4_X
#define ContinuousStates               X_helicopter4_T
#define rtXdot                         helicopter4_XDot
#define StateDerivatives               XDot_helicopter4_T
#define tXdis                          helicopter4_XDis
#define StateDisabled                  XDis_helicopter4_T
#define rtP                            helicopter4_P
#define Parameters                     P_helicopter4_T
#define rtDWork                        helicopter4_DW
#define D_Work                         DW_helicopter4_T

/* Parameters (auto storage) */
struct P_helicopter4_T_ {
...
extern P_helicopter4_T helicopter4_P;

/* Block signals (auto storage) */
extern B_helicopter4_T helicopter4_B;

/* Continuous states (auto storage) */
extern X_helicopter4_T helicopter4_X;

/* Block states (auto storage) */
extern DW_helicopter4_T helicopter4_DW;

/* Model entry point functions */
extern void helicopter4_initialize(void);
extern void helicopter4_output(void);
extern void helicopter4_update(void);
extern void helicopter4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter4_rtModel *helicopter4(void);
...
extern RT_MODEL_helicopter4_T *const helicopter4_M;
 ...
 *
 * '<Root>' : 'helicopter4'
 * '<S1>'   : 'helicopter4/Conversion'
 * '<S2>'   : 'helicopter4/Degrees to Radians'
 * '<S3>'   : 'helicopter4/Elevation controller'
 * '<S4>'   : 'helicopter4/Helicopter_interface'
 * '<S5>'   : 'helicopter4/Pitch controller'
 * '<S6>'   : 'helicopter4/Subsystem'
 * '<S7>'   : 'helicopter4/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter4/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter4/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter4/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter4/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter4_h_ */
