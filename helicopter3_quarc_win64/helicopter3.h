...
#ifndef RTW_HEADER_helicopter3_h_
#define RTW_HEADER_helicopter3_h_
#include <math.h>
#include <string.h>
#ifndef helicopter3_COMMON_INCLUDES_
# define helicopter3_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter3_COMMON_INCLUDES_ */

#include "helicopter3_types.h"
...
#define helicopter3_rtModel            RT_MODEL_helicopter3_T
...
typedef struct {
  ...
  real_T FromWorkspace1[4];            /* '<S7>/From Workspace1' */
  real_T Sum4;                         /* '<Root>/Sum4' */
  real_T elevation_ref;                /* '<Root>/elevation_ref' */
...
#define rtB                            helicopter3_B
#define BlockIO                        B_helicopter3_T
#define rtX                            helicopter3_X
#define ContinuousStates               X_helicopter3_T
#define rtXdot                         helicopter3_XDot
#define StateDerivatives               XDot_helicopter3_T
#define tXdis                          helicopter3_XDis
#define StateDisabled                  XDis_helicopter3_T
#define rtP                            helicopter3_P
#define Parameters                     P_helicopter3_T
#define rtDWork                        helicopter3_DW
#define D_Work                         DW_helicopter3_T

/* Parameters (auto storage) */
struct P_helicopter3_T_ {
...
extern P_helicopter3_T helicopter3_P;

/* Block signals (auto storage) */
extern B_helicopter3_T helicopter3_B;

/* Continuous states (auto storage) */
extern X_helicopter3_T helicopter3_X;

/* Block states (auto storage) */
extern DW_helicopter3_T helicopter3_DW;

/* Model entry point functions */
extern void helicopter3_initialize(void);
extern void helicopter3_output(void);
extern void helicopter3_update(void);
extern void helicopter3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter3_rtModel *helicopter3(void);
...
extern RT_MODEL_helicopter3_T *const helicopter3_M;
 ...
 *
 * '<Root>' : 'helicopter3'
 * '<S1>'   : 'helicopter3/Conversion'
 * '<S2>'   : 'helicopter3/Degrees to Radians'
 * '<S3>'   : 'helicopter3/Degrees to Radians1'
 * '<S4>'   : 'helicopter3/Elevation controller'
 * '<S5>'   : 'helicopter3/Helicopter_interface'
 * '<S6>'   : 'helicopter3/Pitch controller'
 * '<S7>'   : 'helicopter3/Subsystem'
 * '<S8>'   : 'helicopter3/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter3/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter3/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter3/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter3/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter3_h_ */
