...
#ifndef RTW_HEADER_helicopter5_h_
#define RTW_HEADER_helicopter5_h_
#include <math.h>
#include <string.h>
#ifndef helicopter5_COMMON_INCLUDES_
# define helicopter5_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter5_COMMON_INCLUDES_ */

#include "helicopter5_types.h"
...
#define helicopter5_rtModel            RT_MODEL_helicopter5_T
...
#define rtB                            helicopter5_B
#define BlockIO                        B_helicopter5_T
#define rtX                            helicopter5_X
#define ContinuousStates               X_helicopter5_T
#define rtXdot                         helicopter5_XDot
#define StateDerivatives               XDot_helicopter5_T
#define tXdis                          helicopter5_XDis
#define StateDisabled                  XDis_helicopter5_T
#define rtP                            helicopter5_P
#define Parameters                     P_helicopter5_T
#define rtDWork                        helicopter5_DW
#define D_Work                         DW_helicopter5_T

/* Parameters (auto storage) */
struct P_helicopter5_T_ {
...
extern P_helicopter5_T helicopter5_P;

/* Block signals (auto storage) */
extern B_helicopter5_T helicopter5_B;

/* Continuous states (auto storage) */
extern X_helicopter5_T helicopter5_X;

/* Block states (auto storage) */
extern DW_helicopter5_T helicopter5_DW;

/* Model entry point functions */
extern void helicopter5_initialize(void);
extern void helicopter5_output(void);
extern void helicopter5_update(void);
extern void helicopter5_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter5_rtModel *helicopter5(void);
...
extern RT_MODEL_helicopter5_T *const helicopter5_M;
 ...
 *
 * '<Root>' : 'helicopter5'
 * '<S1>'   : 'helicopter5/Conversion'
 * '<S2>'   : 'helicopter5/Degrees to Radians'
 * '<S3>'   : 'helicopter5/Elevation controller'
 * '<S4>'   : 'helicopter5/Helicopter_interface'
 * '<S5>'   : 'helicopter5/Pitch controller'
 * '<S6>'   : 'helicopter5/Subsystem'
 * '<S7>'   : 'helicopter5/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter5/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter5/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter5/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter5/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter5/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter5/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter5_h_ */
